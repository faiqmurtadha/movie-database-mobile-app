...
class SearchListAdapter(private val items: ListFilm) : RecyclerView.Adapter<SearchListAdapter.ViewHolder>() {
    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        context = parent.context
        val inflate = LayoutInflater.from(context).inflate(R.layout.viewholder_search, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val titleText: TextView = itemView.findViewById(R.id.titleFilmSearch)
        val pic: ImageView = itemView.findViewById(R.id.imageFilmSearch)
        val yearText: TextView = itemView.findViewById(R.id.yearFilmSearch)
    }
}